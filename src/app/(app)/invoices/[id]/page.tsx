      ...
      {canRecordPayment ? (
        <section className="mt-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <form action={recordPayment} className="mt-5 grid gap-4 md:grid-cols-2 lg:grid-cols-4 lg:items-end">
            ...
            <FormSubmitButton pendingLabel="Recording…" confirmMessage="Record this payment? Verify the amount, method, and date before continuing." className="rounded-lg bg-sky-600 px-4 py-2.5 text-sm font-semibold text-white hover:bg-sky-700 disabled:opacity-50">Record payment</FormSubmitButton>
