...
export default async function AdminPage() {
  ...
  return <>
    ...
    <section className="grid gap-5 md:grid-cols-2">
      ...
      <div className="rounded-2xl border border-dashed border-slate-300 bg-slate-50 p-6"><h2 className="text-lg font-semibold text-slate-950">Data Tools</h2><p className="mt-2 text-sm leading-6 text-slate-600">Administrative import and maintenance tools will be available here later.</p><span className="mt-5 inline-flex text-sm font-semibold text-slate-500">Coming soon</span></div>
    </section>
  </>;
}
